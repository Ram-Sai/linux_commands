...
set -o  # this will work in combination with set -e command. usually set -e just looks for the error on the last command even when there is pipe. but when you add set -o this will check for the error for all commands and not just last command in the piped command.
echo "Storage"
